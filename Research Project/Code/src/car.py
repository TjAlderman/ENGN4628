class Car:
    def __init__(self, ice_fuel_consumption: float, hybrid_fuel_consumption: float, regen_breaking_percentage: float=0.25, solar_charge_percentage: float=0.5):
        """
        Limitations
        ...
        self.hev_cost_per_100km = self.hev_fc*pc + (1-solar_charge_percentage)*(1-regen_breaking_percentage)*(self.ice_fc-self.hev_fc)*pe*ec
